...
function WhoAreWe() {
  ...
  return (
    ...
    >
      ...
      We are one of few names to offer a vast and qualitive range of industrial steel cut wire shot products. Commited to follow fair business practices, we have earned the desired goodwill in the market.<br/><br/>
